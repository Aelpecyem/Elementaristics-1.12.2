...
public class InitRecipes {
    ...
    private static void initGlory() { //todo add additonal effects to the statues where it's noted; update doc for that, then, too
        ...
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "fire"), Ingredient.fromStacks(new ItemStack(ModItems.scale, 1, Aspects.fire.getId())), ModBlocks.symbol_dragon_fire));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "aether"), Ingredient.fromStacks(new ItemStack(ModItems.scale, 1, Aspects.aether.getId())), ModBlocks.symbol_dragon_aether));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "air"), Ingredient.fromStacks(new ItemStack(ModItems.scale, 1, Aspects.air.getId())), ModBlocks.symbol_dragon_air));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "earth"), Ingredient.fromStacks(new ItemStack(ModItems.scale, 1, Aspects.earth.getId())), ModBlocks.symbol_dragon_earth));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "water"), Ingredient.fromStacks(new ItemStack(ModItems.scale, 1, Aspects.water.getId())), ModBlocks.symbol_dragon_water));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "gate"), Ingredient.fromItem(ModItems.item_lock), ModBlocks.symbol_gate));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "dreamer"), Ingredient.fromItem(ModItems.dagger_sacrificial), ModBlocks.symbol_dreamer));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "angel"), Ingredient.fromItem(ModItems.key_winged), ModBlocks.symbol_angel));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "storm"), Ingredient.fromItem(ModItems.tool_channeling), ModBlocks.symbol_storm));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "fighter"), Ingredient.fromItem(Items.DIAMOND_SWORD), ModBlocks.symbol_fighter));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "sun"), Ingredient.fromItem(ModItems.splendor_eye), ModBlocks.symbol_sun));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "harbinger"), Ingredient.fromStacks(new ItemStack(ModItems.essence, 1, Aspects.night.getId())), ModBlocks.symbol_harbinger));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "queen"), Ingredient.fromItem(Items.RABBIT_FOOT), ModBlocks.symbol_queen));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "goat"), Ingredient.fromStacks(new ItemStack(ModItems.essence, 1, Aspects.wood.getId())), ModBlocks.symbol_goat));
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "moth"), Ingredient.fromItem(ModItems.catalyst_entropizing), ModBlocks.symbol_moth));       //todo: add these once fitting items are in
        GloriousRecipes.addRecipe(new GloriousRecipe(new ResourceLocation(Elementaristics.MODID, "thread"), Ingredient.fromItem(ModItems.protoplasm), ModBlocks.symbol_thread));
