...
import de.aelpecyem.elementaristics.blocks.tileentity.tile.TileEntityPurifier;
...
public class TESRPurifier extends TileEntitySpecialRenderer<TileEntityPurifier> {

    @Override
    public void render(TileEntityPurifier te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
