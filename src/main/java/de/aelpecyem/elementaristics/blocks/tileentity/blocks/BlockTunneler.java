...
public class BlockTunneler extends BlockTileEntity<TileEntityTunneler> {
    public static final PropertyDirection FACING = BlockHorizontal.FACING;

    public BlockTunneler() {
        super(Material.ROCK, "tunneler");
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        TileEntityTunneler tile = getTileEntity(worldIn, pos);
    ...
    @Override
    public Class<TileEntityTunneler> getTileEntityClass() {
        return TileEntityTunneler.class;
    }

    @Nullable
    @Override
    public TileEntityTunneler createTileEntity(World world, IBlockState state) {
        return new TileEntityTunneler();
    }
}
