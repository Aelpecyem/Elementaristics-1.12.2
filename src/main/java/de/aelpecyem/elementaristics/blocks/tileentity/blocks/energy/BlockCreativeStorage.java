...
public class BlockCreativeStorage extends BlockTileEntity<TileEntityCreativeStorage> {

    public static final PropertyDirection FACING = BlockHorizontal.FACING;

    public BlockCreativeStorage() {
        super(Material.ROCK, "storage_energy_creative");
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if (!worldIn.isRemote) {
            TileEntityCreativeStorage tile = getTileEntity(worldIn, pos);
    ...
    @Override
    public Class<TileEntityCreativeStorage> getTileEntityClass() {
        return TileEntityCreativeStorage.class;
    }

    @Override
    public TileEntityCreativeStorage createTileEntity(World world, IBlockState state) {
