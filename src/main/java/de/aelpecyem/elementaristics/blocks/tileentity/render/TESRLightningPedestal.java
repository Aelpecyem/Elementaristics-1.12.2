...
public class TESRLightningPedestal extends TileEntitySpecialRenderer<TileEntityLightningPedestal> {

    @Override
    public void render(TileEntityLightningPedestal te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
