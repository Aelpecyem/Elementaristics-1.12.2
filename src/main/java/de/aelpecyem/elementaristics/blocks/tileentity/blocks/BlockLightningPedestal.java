...
public class BlockLightningPedestal extends BlockTileEntity<TileEntityLightningPedestal> {

    public static final PropertyDirection FACING = BlockHorizontal.FACING;

    public BlockLightningPedestal() {
        super(Material.ROCK, "pedestal_lightning");
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        TileEntityLightningPedestal tile = getTileEntity(worldIn, pos);
    ...
    @Override
    public Class<TileEntityLightningPedestal> getTileEntityClass() {
        return TileEntityLightningPedestal.class;
    }

    @Override
    public TileEntityLightningPedestal createTileEntity(World world, IBlockState state) {
        return new TileEntityLightningPedestal();
    }
}
